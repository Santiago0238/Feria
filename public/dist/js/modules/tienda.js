...
const TiendaModule = {
    premios: [
        ...
        { id: 3, name: "Cuaderno ecologico", desc: "Cuaderno hecho con papel reciclado.", cost: 250, stock: 10, icon: "fa-book" },
        { id: 4, name: "Botella reutilizable UAJMS", desc: "Botella reutilizable para reducir plastico.", cost: 500, stock: 5, icon: "fa-bottle-water" },
        { id: 5, name: "Vale de cafeteria", desc: "Vale simulado para consumo en cafeteria universitaria.", cost: 700, stock: 3, icon: "fa-ticket" }
    ],
